...
import LeftSec from "./LeftSection";
import RightSec from "./RightSection";
  ...
  return (
    <>
      ...
      <RightSec
        ...
        productName="Console"
        productDesc="The central dashboard for your TradeFlow account. Gain insights into your trades and investments with in-depth reports and visualisations."
        learnMore=""
      />
      ...
      <p className="text-center mt-5 mb-5">
        Want to know more about our technology stack? Check out our
        TradeFlow.tech blog.
      </p>
